/**
 * Q-1 - How to define 2D array?
 * 
 * Q - Why we have to define 2D array
 * ANS - When we need to store data in table format then we use 2-D Array
 * 
 * Steps to Define 2D Array
 * Step 1 - We will define normal Array
 */
...
let twoDArray = [
                    ['Mayank', 'B.tech', 'IIT-K', 69],
                    ["Arrohoi", "B.tech", "NSIT", 80],
